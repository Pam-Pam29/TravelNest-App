...
const BookingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Creating booking with email:", currentUser.email);
      ...
      alert(`Booking created! ID: ${bookingId}`); // Add alert for visibility (. About to navigate to payment.); 
    ...
    <div className="booking-form-container">
      ...
      <form onSubmit={handleSubmit} className="booking-form">
        ...
        <div className="custom-package-note">
          <p>Looking for more customization options? <a href="/custom-package">Create a custom travel package</a> instead.</p>
        </div>
